        ...
        try {
            ...
            while (rs.next()) {
                ...
                out.println("<li class=\"span3\">\n"
                        ...
                        + "				   <h4 style=\"text-align:center;\"><a class=\"btn\" href=\"product_details.html\"> <i class=\"icon-zoom-in\"></i></a>  <a class=\"btn btn-primary\" style=\"pointer-events: none; cursor: default;\">" + rs.getString("price") + " $</a></h4>\n"
                        + "				</div>\n"
                        + "			  </div>\n"
                        + "			</li>"
                );
